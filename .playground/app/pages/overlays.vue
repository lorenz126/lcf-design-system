...
useCommands(() => [
  ...
  {
    id: 'ov-drawer',
    label: 'Open the filters drawer',
    group: 'This page',
    icon: PanelRight,
    keywords: ['sidepanel', 'panel'],
    run: () => { filters.value = true }
  }
])
...
<template>
  <div>
    ...
    <section>
      <div class="sec-label">CommandPalette</div>
      <div class="row">
      ...
      <p class="t-caption hint">
        ...
        <em>Open the filters drawer</em> — are registered by <em>this page</em>. Open the
