...
useHead({ title: 'Toc — Design Framework' })
...
<template>
  <div>
    <div class="intro">
      <p class="t-lead lede">It reads the document rather than being told about it.</p>
      <p class="t-body body">
        Handed an element, it walks the headings that are actually in it and tracks
        which one you are next to. That is a data shape — the document’s — which is why
        it is an organism and <NuxtLink to="/molecules/prose">Prose</NuxtLink> is not.
      </p>
    </div>
